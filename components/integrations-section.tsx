    ...
    return (
      ...
      >
        ...
        <div className="relative mx-auto max-w-7xl px-4 xs:px-6 sm:px-6 md:px-8 lg:px-8 xl:px-12">
          <div className="flex flex-col items-start md:items-center gap-12 xs:gap-16 sm:gap-20 md:gap-24 lg:gap-28 xl:gap-16">
            ...
            <SectionHeader
              ...
              headingClassName="max-w-full xs:max-w-lg sm:max-w-2xl md:max-w-3xl lg:max-w-4xl xl:max-w-[743px] md:mx-auto"
              subheadingClassName="max-w-full xs:max-w-md sm:max-w-2xl md:max-w-3xl lg:max-w-4xl xl:max-w-[735px] md:mx-auto"
            />
