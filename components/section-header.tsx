    ...
    return (
      <header
        ...
        className={cn(
          ...
          "w-full",
          centered && "items-start text-left md:items-center md:text-center",
          className
        )}
        {...props}
      >
        <h2
          className={cn(
            ...
            "text-3xl xs:text-4xl sm:text-5xl md:text-4xl lg:text-5xl xl:text-5xl",
            // Font and styling
        ...
        {subheading && (
          <p
            className={cn(
              ...
              "text-base xs:text-lg sm:text-xl md:text-lg lg:text-xl xl:text-[16px]",
              ...
              "leading-relaxed xs:leading-relaxed sm:leading-relaxed md:leading-relaxed lg:leading-relaxed xl:leading-[22px]",
              // Responsive max width
