    ...
    return (
      ...
      >
        ...
        <div className="relative mx-auto max-w-7xl px-4 xs:px-6 sm:px-6 md:px-8 lg:px-8 xl:px-12">
          <div className="flex flex-col items-start md:items-center gap-12 xs:gap-16 sm:gap-20 md:gap-24 lg:gap-28 xl:gap-[72px]">

            {/* Header and Menubar Section */}
            <div className="flex flex-col items-start md:items-center gap-8 xs:gap-10 sm:gap-12 md:gap-16 lg:gap-20 xl:gap-[67px] w-full max-w-full xs:max-w-2xl sm:max-w-4xl md:max-w-5xl lg:max-w-6xl xl:max-w-[797px]">

              {/* Section Header */}
              <div className="flex flex-col items-start md:items-center gap-4 xs:gap-5 sm:gap-6 md:gap-7 lg:gap-8 xl:gap-[36px]">
                <SectionHeader
